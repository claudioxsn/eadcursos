    ...
    <div class="col-lg-10">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <hr>
                <form action="<?php echo e(route('administrador.aula.register.submit')); ?>" method="POST"  enctype="multipart/form-data" novalidate="novalidate">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input id="titulo" name="titulo" type="text" class="form-control" aria-required="true"
                            aria-invalid="false" placeholder="Título da Aula" value="<?php echo e(old('titulo')); ?>">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input id="dataAula" name="dataAula" type="date" class="form-control" aria-required="true"
                                    aria-invalid="false" value="<?php echo e(old('dataAula')); ?>">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input id="horaAula" name="horaAula" type="time" class="form-control"
                                        aria-required="true" aria-invalid="false" value="<?php echo e(old('horaAula')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input id="linkAula" name="linkAula" type="text" class="form-control" aria-required="true"
                            aria-invalid="false" placeholder="Link da aula ao vivo" value="<?php echo e(old('linkAula')); ?>">
                        <?php if($errors->has('titulo')): ?>
                            <div class="div-invalid-feedback">
                                <?php echo e($errors->first('titulo')); ?>
...
<?php echo $__env->make('administrador.template.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/claudio/repositorios/especializacaoIbpc/resources/views/administrador/aulas/cadastrarAula.blade.php ENDPATH**/ ?>