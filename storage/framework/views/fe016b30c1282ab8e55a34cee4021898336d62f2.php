                        ...
                        <div class="tab-pane fade show active" id="principal" role="tabpanel"
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="<?php echo e(route('aluno.perfil.update')); ?> "
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cpf" id="cpf" placeholder="CPF"
                                                        class="form-control" value="<?php echo e(old('cpf') ?? $aluno->cpf); ?>" readonly>
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="rg" id="rg" placeholder="RG"
                                                        class="form-control" value="<?php echo e(old('rg') ?? $aluno->rg); ?>" readonly>
...
<?php echo $__env->make('aluno.template.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/claudio/repositorios/especializacaoIbpc/resources/views/aluno/perfil/alterar.blade.php ENDPATH**/ ?>