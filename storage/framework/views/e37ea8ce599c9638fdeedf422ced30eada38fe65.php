                                        ...
                                        <?php $__currentLoopData = $matriculas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="w-30 p-3"><a
                                                        ...
                                                        <a
                                                        href="<?php echo e(route('administrador.aluno.bloquearMatricula', ['id' => Crypt::encrypt($m->idMatricula)])); ?>"
                                                        class="btn btn-danger btn-sm">Bloquear</a>
                                                        <a
                                                        href="<?php echo e(route('administrador.aluno.cancelarMatricula', ['id' => Crypt::encrypt($m->idMatricula)])); ?>"
...
<?php echo $__env->make('administrador.template.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/claudio/repositorios/especializacaoIbpc/resources/views/administrador/curso/alunosMatriculados.blade.php ENDPATH**/ ?>