                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="<?php echo e(route('aluno.login.submit')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="<?php echo e(route('aluno.password.formResetPassword')); ?>">Esqueceu sua Senha?</a>
                                    </label>
                                </div>
...
<!-- end document-->
<?php /**PATH /home/claudio/repositorios/especializacaoIbpc/resources/views/aluno/auth/loginForm.blade.php ENDPATH**/ ?>