                        ...
                        <div class="tab-pane fade show active" id="principal" role="tabpanel"
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="<?php echo e(route('aluno.password.update')); ?>" method="POST">
...
<?php echo $__env->make('aluno.template.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/claudio/repositorios/especializacaoIbpc/resources/views/aluno/perfil/alterarSenha.blade.php ENDPATH**/ ?>