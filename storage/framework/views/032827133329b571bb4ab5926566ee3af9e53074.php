...
<head>
    ...
    <!-- Title Page-->
    <title>Clinica IBPC - Restaurar Senha</title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="<?php echo e(route('aluno.password.sendResetPasswordLink')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<!-- end document-->
<?php /**PATH /home/claudio/repositorios/especializacaoIbpc/resources/views/aluno/auth/formForgotPassword.blade.php ENDPATH**/ ?>