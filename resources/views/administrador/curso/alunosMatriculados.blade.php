                                        ...
                                        @foreach ($matriculas as $m)
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="w-30 p-3"><a
                                                        ...
                                                        <a
                                                        href="{{ route('administrador.aluno.bloquearMatricula', ['id' => Crypt::encrypt($m->idMatricula)]) }}"
                                                        class="btn btn-danger btn-sm">Bloquear</a>
                                                        <a
                                                        href="{{ route('administrador.aluno.cancelarMatricula', ['id' => Crypt::encrypt($m->idMatricula)]) }}"
