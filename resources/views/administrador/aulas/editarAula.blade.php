    ...
    <div class="col-lg-10">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <hr>
                <form action="{{ route('administrador.aula.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="aula_id" id="aula_id" value="{{ Crypt::encrypt($aula->id) }}">
                    <div class="form-group">
                        ...
                        <input id="titulo" name="titulo" type="text" class="form-control" aria-required="true"
                            aria-invalid="false" placeholder="Título da Aula" value="{{ $aula->titulo }}">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="tipo" id="tipo" class="form-control">
                                    <option value="Aula" {{ ($aula->tipo =='Aula' ? 'selected' : '') }}>Aula</option>
                                    <option value="Supervisao" {{ ($aula->tipo == 'Supervisao' ? 'selected' : '' ) }}>Supervisão
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input id="dataAula" name="dataAula" type="date" class="form-control" aria-required="true"
                                    aria-invalid="false" value="{{ $aula->dataAula }}">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input id="horaAula" name="horaAula" type="time" class="form-control"
                                        aria-required="true" aria-invalid="false" value="{{ $aula->horaAula }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="linkAula" name="linkAula" type="text" class="form-control" aria-required="true"
                            aria-invalid="false" placeholder="Link da aula ao vivo" value="{{ $aula->linkAula }}">
                        @if ($errors->has('linkAula'))
                            <div class="div-invalid-feedback">
                                {{ $errors->first('linkAula') }}
                            </div>
                        @endif
                    </div>
                    <div class="form-group">
                        <div class="mb-3">
                            ...
                            <input class="form-control" accept="file_extension|audio/*|video/*|image/*|media_type"
                                type="file" id="arquivoVideo" name="arquivoVideo" value="{{ $aula->arquivoVideo }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="mb-3">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-12">
                            <textarea name="descricao" id="descricao" rows="3" placeholder="Conteúdo abordado"
                                class="form-control">{{ $aula->descricao }}</textarea>
