        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    ...
                    <a href="{{ route('administrador.logout') }}">Sair</a>
                </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{ route('administrador.aluno.list') }}">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{ route('administrador.curso.register') }}">
                                        <i class="fas fa-tachometer-alt"></i>Cadastrar</a>
                                </li>
                                <li>
                                    <a href="{{ route('administrador.curso.list') }}">
                                        <i class="fas fa-tachometer-alt"></i>Buscar</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="header-wrap2">
                            ...
                            <div class="header-button2">
                                ...
                                <div class="setting-menu js-right-sidebar d-none d-lg-block">
                                    ...
                                    <div class="account-dropdown__body">
                                        <div class="account-dropdown__item">
                                            <a href="{{ route('administrador.logout') }}">
