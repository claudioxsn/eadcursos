                        ...
                        <div class="tab-pane fade show active" id="principal" role="tabpanel"
                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="{{ route('administrador.aluno.update') }} "
                                        method="POST">
                                        @csrf
                                        @method('put')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status" id="status">
                                                        ...
                                                        <option value="Bloqueado"
                                                            {{ $aluno->status == 'Bloqueado' ? 'selected' : '' }}>
                                                            Bloqueado</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cpf" id="cpf" placeholder="CPF"
                                                        class="form-control" value="{{ old('cpf') ?? $aluno->cpf }}">
                                                    @if ($errors->has('cpf'))
                                                        <div class="div-invalid-feedback ">
                                                            {{ $errors->first('cpf') }}
                                                        </div>
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="rg" id="rg" placeholder="RG"
                                                        class="form-control" value="{{ old('rg') ?? $aluno->rg}}">
                                                    @if ($errors->has('rg'))
                                                        <div class="div-invalid-feedback ">
                                                            {{ $errors->first('rg') }}
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="observacoes" class="form-control" id="observacoes"
                                                rows="4">{{ old('observacoes') ?? $aluno->observacoes}}</textarea>
                                        </div>
                                </div>
