...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/jlplayer.css') }} ">
...
<body class="animsition">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="{{ route('aluno.dashboard') }}">
                    <img src="{{ asset('images/logo_branco_navbar.png') }}" width="150" height="200" />
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="{{ asset('images/avatar_student.png') }}" alt="John Doe" />
                    </div>
                    <h4 class="name">{{ Auth::user()->nome }}</h4>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{ route('aluno.perfil.edit') }}">
                                        <i class="fa fa-user"></i>Editar Perfil</a>
                                </li>
                                <li>
                                    <a href="{{ route('aluno.password.edit') }}">
                                        <i class="fa fa-key"></i>Alterar Senha</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ route('aluno.curso.meusCursos') }}">
                                <i class="fa fa-play"></i>Meus Cursos</a>
                        </li>
                       @foreach(DB::table('cursos')->join('matricula_cursos', 'matricula_cursos.curso_id', '=', 'cursos.id')->join('alunos', 'alunos.id', '=', 'matricula_cursos.aluno_id')->select('cursos.nome as nomeCurso','cursos.linkPagamento','matricula_cursos.curso_id as curso_id',)->where('matricula_cursos.aluno_id', '=', Auth::user()->id)->get() as $c)
                                <li>
                                    <a href=" {{ $c->linkPagamento}}" target="_blank">
        ...
        <div class="page-container2">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="{{ asset('images/logo_branco_navbar.png') }}" width="150"
                                        height="200" />
                                </a>
                            </div>
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="{{ asset('images/avatar_student.png') }}" />
                        </div>
                        <h4 class="name">{{ Auth::user()->nome }}</h4>
                        <a href="{{ route('aluno.logout') }}">Sair</a>
                    </div>
    ...
    <script src="{{ asset('js/jlplayer.js')}}" async></script>
